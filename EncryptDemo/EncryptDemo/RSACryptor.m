...
// 填充模式
#define kTypeOfWrapPadding        kSecPaddingOAEP

// 公钥/私钥标签
#define kPublicKeyTag            "com.Sharon.EncryptDemo.publickey"
#define kPrivateKeyTag            "com.Sharon.EncryptDemo.privatekey"
...
- (NSData *)encryptData:(NSData *)plainData {
    ...
    } else if (kTypeOfWrapPadding == kSecPaddingPKCS1){
        NSAssert(keyBufferSize <= (cipherBufferSize - 11), @"加密内容太大");
    }else if(kTypeOfWrapPadding == kSecPaddingOAEP){
        NSAssert(keyBufferSize <= (cipherBufferSize - 42), @"加密内容太大");
    }
